...
<form action="guest_store_mem_comments_db.jsp">
...
<jsp:include page="homeframe.html"></jsp:include>

<%-- <%


RequestDispatcher rd=request.getRequestDispatcher("homeframe.html");
