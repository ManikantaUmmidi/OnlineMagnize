...
%>
 <tr>
   <td align="center"><font size="2" color="olive"><%=r.getInt(1)%></font></td>
   <td align="center"><font size="2" color="olive"><%=r.getString(5)%></font></td>
   <td align="center"><font size="2" color="olive"><%=r.getString(6)%></font></td>
 </tr>
<%
		}
    }
