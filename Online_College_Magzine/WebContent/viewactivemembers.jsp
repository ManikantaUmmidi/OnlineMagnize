...
<div id="mySidenav" class="sidenav">
  ...
  <a href="add_moderator.jsp" id="cont">Add Reviewer</a>
...
try
{
	...
	st=con.createStatement();
     ResultSet rs=  st.executeQuery("select * from member_profile where status='Activated'");
     ...
     while(rs.next())
     {
    	...
    	<td><a href="activate.jsp?mid=<%=rs.getString(1)%>&email=<%=rs.getString(4) %>" target="home">Activated</a></td>
