	...
	if((i==1)&&(j==1))
	{
		...
		rs2.next();
		  ...
		  String host="", user="", pass="";
		   ...
		   String footerText=" Regards <br><br>Nikhil kaki,<br>  Editor<br> KITE-OCM";
		   
		   
		   String messageText ="<div style='border:2px solid green;width:350px;background-color:Tomato; '>Hello"+rs2.getString(3)+" Your Post "+rs1.getString(3)+" <br>"+" is Acivated "+"Now Your Post is Live"+"<br><br><br>"+footerText+"</div>";
		...
		response.sendRedirect("inbox2.jsp");
	}
}
catch(Exception e)
{
